// P3.0+ placeholder entry shim — @forgeax-extension/cli-codex (kind=cli-provider)
...
// codex exec --json subprocess 适配. Until then: import is side-effect free (no top-level throw,
...
const PHASE_6_PLUS_MESSAGE =
  "[Phase 6+ shim] @forgeax-extension/cli-codex · CliProvider runner 未实现。" +
