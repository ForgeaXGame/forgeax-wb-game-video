...
- `L0` = `packages/marketplace/extensions/<kind>/<slug>/`(打包进仓库,所有人都看到)
- `L1` = `~/.forgeax/extensions/<kind>/<slug>/`(用户全局,不入仓)
- `L2` = `<projectRoot>/.forgeax/extensions/<kind>/<slug>/`(本项目私有,Git-friendly)
...
得到答案后,定下:
- 目录: 本指南创建 tool,通常用 `<projectRoot>/.forgeax/extensions/tool/<slug>/`
...
- 真实复杂例子: `packages/marketplace/extensions/workbench/wb-character/`(workbench kind, 12 个 tools)
