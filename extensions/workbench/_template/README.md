...
```bash
cp -r packages/marketplace/extensions/workbench/_template packages/marketplace/extensions/workbench/wb-my-thing
cd packages/marketplace/extensions/workbench/wb-my-thing
