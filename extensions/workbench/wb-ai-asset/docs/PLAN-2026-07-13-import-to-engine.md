...
> **状态**：🟢 DONE（2026-07-14 随 marketplace `#55` 合 main）
...
- 收口 / 验收：[`../wb-gen3d/docs/HANDOFF-2026-07-13-import-to-engine-review.md`](../wb-gen3d/docs/HANDOFF-2026-07-13-import-to-engine-review.md)
...
对本插件已落地：保留生成时自动 cook；「导入到游戏 / 重新导入」UI；Draco 仅手动导入时转换；共享 `shared/external-asset-meta`（S1）。
