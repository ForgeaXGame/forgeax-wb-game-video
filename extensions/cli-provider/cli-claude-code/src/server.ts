// P3.0+ placeholder entry shim — @forgeax-extension/cli-claude-code (kind=cli-provider)
...
const PHASE_6_PLUS_MESSAGE =
  "[Phase 6+ shim] @forgeax-extension/cli-claude-code · CliProvider runner 未实现。" +
  "当前为 marketplace placeholder · Phase 6+ 拆 plugin 时填实际 claude --mode stream subprocess 适配";
