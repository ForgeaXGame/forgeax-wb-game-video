...
import { registerKind, getKind, unregisterKind, deriveOutputs, type KindPlugin } from '../kind-registry'
...
describe('kind-registry', () => {
  ...
  it('runtime contracts: logic run + interaction resolve', () => {
    ...
    expect(inter.resolve!({ state: {} as never, nodeId: 'n', elapsedMs: 0 }, {}, 'hit').outcome).toBe('pass')
