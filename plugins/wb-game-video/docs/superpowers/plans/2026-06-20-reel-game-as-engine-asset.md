...
**P0 — per-game media**
- Modify: `packages/marketplace/plugins/wb-reel/vite.config.ts` (the `reelAssetsPlugin`: resolve `.reel-assets` per-slug)
- Test: `packages/marketplace/plugins/wb-reel/src/media/__tests__/perGameAssetsDir.test.ts`
...
- Create: `packages/marketplace/plugins/wb-reel/src/scenario/pkg/buildReelGameAsset.ts` (pure: Scenario + media-resolver → `{ packJson, mediaFiles }`)
- Create: `packages/marketplace/plugins/wb-reel/src/scenario/pkg/reelGamePayload.ts` (shared payload shape + extraction pure fn, used by loader + standalone reader)
...
- Test: `packages/marketplace/plugins/wb-reel/src/scenario/pkg/__tests__/buildReelGameAsset.test.ts`

**P3 — standalone bundle**
- Create: `packages/build/reel-src/export/build-reel-standalone.ts` (mirror `build-standalone.ts`)
- Create: `packages/marketplace/plugins/wb-reel/src/player/loadReelGameFromPackIndex.ts` (WebGPU-free reader)
- Modify: `packages/marketplace/plugins/wb-reel/src/App.tsx` (player-only boot can source scenario from a pack-index when `?src=pack`)
- Test: `packages/marketplace/plugins/wb-reel/src/player/__tests__/loadReelGameFromPackIndex.test.ts`
...
**Files:**
- Modify: `packages/marketplace/plugins/wb-reel/vite.config.ts` (`reelAssetsPlugin`, dir at line ~1151; route `/__reel__/assets` ~503; ID/path ~592-607)
- Test: `packages/marketplace/plugins/wb-reel/src/media/__tests__/perGameAssetsDir.test.ts`
...
Run: `cd packages/marketplace/plugins/wb-reel && pnpm vitest run src/media/__tests__/perGameAssetsDir.test.ts`
...
- [ ] **Step 6: Make the frontend send the slug on every asset call.** In `packages/marketplace/plugins/wb-reel/src/media/assetStore.ts`, append `gameQuery()` (from `../shell/gameScope`) to `ENDPOINT` reads/writes and to `urlOf(id)` (`assetStore.ts:23,406`). Example: `urlOf = (id) => `/__reel__/assets/${id}${gameQuery()}``.
...
```bash
git add packages/marketplace/plugins/wb-reel/vite.config.ts \
  packages/marketplace/plugins/wb-reel/src/media/assetStore.ts \
  packages/marketplace/plugins/wb-reel/src/media/__tests__/perGameAssetsDir.test.ts
...
**Files:**
- Create: `packages/marketplace/plugins/wb-reel/src/scenario/pkg/reelGamePayload.ts`
- Test: `packages/marketplace/plugins/wb-reel/src/scenario/pkg/__tests__/reelGamePayload.test.ts`
...
Run: `cd packages/marketplace/plugins/wb-reel && pnpm vitest run src/scenario/pkg/__tests__/reelGamePayload.test.ts`
...
**Files:**
- Create: `packages/marketplace/plugins/wb-reel/src/scenario/pkg/buildReelGameAsset.ts`
- Test: `packages/marketplace/plugins/wb-reel/src/scenario/pkg/__tests__/buildReelGameAsset.test.ts`
...
**Files:**
- Create: `packages/marketplace/plugins/wb-reel/src/player/loadReelGameFromPackIndex.ts`
- Test: `packages/marketplace/plugins/wb-reel/src/player/__tests__/loadReelGameFromPackIndex.test.ts`
...
**Files:**
- Modify: `packages/marketplace/plugins/wb-reel/src/App.tsx` (player-only branch, ~493-498 / 603-611)
