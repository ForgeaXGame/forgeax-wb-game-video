// P3.0+ placeholder entry shim — @kubeela-plugin/model-anthropic-text (kind=model-binding)
...
const PHASE_6_PLUS_MESSAGE =
  "[Phase 6+ shim] @kubeela-plugin/model-anthropic-text · ModelBindingPlugin 未实现。" +
