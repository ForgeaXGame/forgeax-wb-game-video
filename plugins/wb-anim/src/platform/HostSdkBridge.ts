...
/**
 * Phase A4 — host-sdk bridge for wb-anim iframe.
 *
 ...
 * wb-anim is its own vite build with separate node_modules; pulling in
 ...
 * add it here only when wb-anim actually needs it.
 *
