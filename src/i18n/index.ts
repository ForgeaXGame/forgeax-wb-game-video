...
const EN: Record<string, string> = {
  ...
  'bootstrap.guide.title': 'Create a video game',
  'bootstrap.guide.description':
    'Would you like to create a video game for this workspace? The first setup prepares project files.',
  'bootstrap.guide.yes': 'Yes, create video game',
...
const ZH: Record<string, string> = {
  ...
  'bootstrap.retry': '重试',
  'bootstrap.guide.title': '创建视频游戏',
  'bootstrap.guide.description': '是否为当前项目创建视频游戏？首次设置会准备项目基础文件。',
  'bootstrap.guide.yes': '是，创建视频游戏',
