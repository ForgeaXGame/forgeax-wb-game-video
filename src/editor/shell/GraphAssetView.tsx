...
.alx-toolbar { position: relative; z-index: 10; display: flex; height: 52px; min-height: 52px; align-items: center; gap: 16px; overflow-x: auto; padding: 12px 24px; border-bottom: 1px solid var(--asset-border); background: var(--asset-surface); scrollbar-width: none; }.alx-toolbar::-webkit-scrollbar { display: none; }
...
.alx-toolbar-menu-anchor { position: relative; }
.alx-toolbar-more,.alx-toolbar-more:hover,.alx-toolbar-more:focus-visible,.alx-toolbar-more:active,.alx-toolbar-more.is-on,.alx-toolbar button.alx-toolbar-more.is-on { display: grid; width: 24px; height: 24px; place-items: center; border: 0; border-radius: 4px; padding: 0; background: transparent !important; box-shadow: none; font: inherit; font-size: 17px; line-height: 1; letter-spacing: 1px; cursor: pointer; }.alx-toolbar-more { color: var(--asset-text-secondary); }.alx-toolbar-more:hover,.alx-toolbar-more:focus-visible,.alx-toolbar-more:active,.alx-toolbar-more.is-on { color: var(--asset-text-primary); }
.alx-toolbar-menu { position: fixed; z-index: 2147483647; display: flex; width: 114px; flex-direction: column; gap: 4px; padding: 8px; border: 1px solid rgba(255,255,255,.1); border-radius: 8px; background: #141414; box-shadow: 0 8px 20px rgba(0,0,0,.4); }.alx-toolbar-menu button { height: 40px; border: 0; border-radius: 8px; padding: 8px; color: #fff; background: transparent; font: inherit; font-size: 16px; font-weight: 500; text-align: center; cursor: pointer; }.alx-toolbar-menu button:hover:not(:disabled) { background: rgba(255,255,255,.1); }.alx-toolbar-menu button:disabled { cursor: not-allowed; opacity: .4; }.alx-toolbar-menu [role="separator"] { height: 1px; margin: 4px 0; background: rgba(255,255,255,.1); }
.alx-new-folder-button { display: inline-flex; height: 28px; flex: 0 0 auto; align-items: center; gap: 6px; border: 0; border-radius: 6px; padding: 2px 8px; color: var(--asset-text-primary); background: var(--asset-overlay); font: inherit; font-size: var(--asset-toolbar-font-size); line-height: 24px; white-space: nowrap; cursor: pointer; }.alx-new-folder-button:hover:not(:disabled) { background: var(--asset-overlay-hover); }.alx-new-folder-button:disabled { cursor: not-allowed; opacity: .45; }
...
.alx-card-actions { position: absolute; top: 6px; left: 6px; z-index: 50; display: flex; align-items: center; gap: 6px; opacity: 0; transition: opacity var(--motion-duration-fast) var(--motion-ease-out); }.alx-folder-card:hover .alx-card-actions,.alx-folder-card:focus-within .alx-card-actions,.alx-asset-card:hover .alx-card-actions,.alx-asset-card:focus-within .alx-card-actions { opacity: 1; }.alx-card-copy,.alx-card-menu-trigger { display: grid; width: 18px; height: 18px; place-items: center; border: 0; border-radius: 6px; padding: 0; background: transparent; cursor: pointer; }.alx-card-copy { background: rgba(255,255,255,.1); }.alx-card-copy img { width: 14px; height: 14px; }.alx-card-menu-trigger img { display: block; width: 18px; height: 18px; }.alx-card-copy:hover,.alx-card-copy:focus-visible { background: rgba(255,255,255,.2); }.alx-card-menu-trigger:hover,.alx-card-menu-trigger:focus-visible { filter: brightness(1.25); }.alx-card-menu { position: fixed; z-index: 2147483647 !important; display: flex; width: 114px; flex-direction: column; gap: 4px; border: 1px solid rgba(255,255,255,.1); border-radius: 8px; padding: 8px; pointer-events: auto; background: #141414; box-shadow: 0 8px 20px rgba(0,0,0,.4); }.alx-card-menu button { height: 40px; border: 0; border-radius: 8px; padding: 8px; color: #fff; background: transparent; font: inherit; font-size: 16px; font-weight: 500; text-align: center; cursor: pointer; }.alx-card-menu button:hover:not(:disabled) { background: rgba(255,255,255,.1); }.alx-card-menu button:disabled { cursor: not-allowed; opacity: .4; }
...
.alx-dialog h2,.alx-dialog p { margin: 0; }.alx-dialog label { display: flex; flex-direction: column; gap: 6px; font-size: 12px; }.alx-dialog input,.alx-dialog select { padding: 8px; border: 1px solid var(--asset-border); border-radius: 5px; color: var(--asset-text-primary); background: var(--asset-canvas); }
...
.alx-folder-dialog { position: relative; box-sizing: border-box; width: min(450px, calc(100% - 32px)); min-height: 300px; justify-content: space-between; gap: 16px; padding: 40px; border-color: rgba(255,255,255,.2); border-radius: 16px; background: #141414; }.alx-folder-dialog h2 { width: 100%; color: #fff; font-size: 24px; font-weight: 600; line-height: 1.5; text-align: center; }.alx-folder-dialog label { gap: 8px; color: #fff; font-size: 16px; }.alx-folder-dialog input { box-sizing: border-box; width: 100%; height: 40px; border-color: rgba(255,255,255,.6); border-radius: 8px; padding: 0 16px; font-size: 14px; background: transparent; }.alx-folder-dialog.is-delete p { display: flex; flex: 1; align-items: center; color: #fff; font-size: 16px; line-height: 1.5; text-align: center; }.alx-folder-dialog-close { position: absolute; top: 20px; right: 20px; display: grid; width: 28px; height: 28px; place-items: center; border: 0 !important; padding: 0 !important; color: #fff !important; background: transparent !important; font-size: 30px; font-weight: 200; line-height: 1; }.alx-folder-dialog-actions { display: flex; justify-content: center !important; gap: 16px !important; }.alx-folder-dialog-actions button { width: 120px; height: 32px; border: 0 !important; border-radius: 8px !important; padding: 1px 28px !important; color: #000 !important; font-size: 16px; font-weight: 700; }.alx-folder-dialog-actions button:first-child { background: #fff !important; }.alx-folder-dialog-actions button:last-child { background: linear-gradient(90deg, #ff7001, #ff9c2a) !important; }.alx-folder-dialog-actions button:disabled { cursor: not-allowed; opacity: .45; }
.alx-move-dialog { position: relative; width: min(600px, calc(100% - 32px)); gap: 40px; padding: 40px; border-color: #515151; border-radius: 16px; background: #141414; }.alx-move-dialog-content { display: flex; width: 100%; flex-direction: column; gap: 16px; }.alx-move-dialog h2 { width: 100%; font-size: 20px; font-weight: 700; line-height: 1.5; text-align: center; }.alx-move-dialog label { gap: 8px; color: #fff; font-size: 14px; font-weight: 500; letter-spacing: .44px; }.alx-move-dialog-close { position: absolute; top: 16px; right: 20px; display: grid; width: 32px; height: 32px; place-items: center; border: 0 !important; padding: 0 !important; color: #fff !important; background: transparent !important; font-size: 30px; font-weight: 200; line-height: 1; }.alx-move-tree { box-sizing: border-box; height: 394px; overflow: auto; border-radius: 8px; padding: 8px; background: #333; }.alx-move-tree-root { display: flex; height: 42px; align-items: center; gap: 8px; border-bottom: 1px solid rgba(255,255,255,.1); padding: 0 8px; color: #fff; font-size: 16px; }.alx-move-dialog .alx-move-tree-row,.alx-move-dialog .alx-move-tree-new { display: flex; width: 100%; height: 42px; align-items: center; gap: 8px; border: 0; border-bottom: 1px solid rgba(255,255,255,.1); border-radius: 0; padding-right: 8px; color: #fff; background: transparent !important; font: inherit; font-size: 16px; text-align: left; cursor: pointer; }.alx-move-dialog .alx-move-tree-row:hover,.alx-move-dialog .alx-move-tree-row.is-selected { background: rgba(255,255,255,.1) !important; }.alx-move-tree-row > span { display: inline-grid; width: 20px; place-items: center; }.alx-move-dialog .alx-move-tree-new { padding-left: 16px; }.alx-move-dialog .alx-move-tree-new:hover { background: rgba(255,255,255,.1) !important; }.alx-move-tree-create { display: flex !important; height: 42px; align-items: center; gap: 6px !important; border-bottom: 1px solid rgba(255,255,255,.1); padding: 0 8px; }.alx-move-tree-create input { min-width: 0; flex: 1; border: 1px solid rgba(255,255,255,.2); border-radius: 4px; padding: 5px 7px; color: #fff; background: #1a1a1a; font: inherit; font-size: 13px; }.alx-move-dialog .alx-move-tree-create button { height: 26px; border: 0; border-radius: 4px; padding: 0 7px; color: #fff; background: rgba(255,255,255,.1); font: inherit; font-size: 12px; cursor: pointer; }.alx-move-dialog .alx-move-tree-create button:disabled { cursor: not-allowed; opacity: .45; }.alx-move-dialog-actions { display: flex; width: 100%; gap: 24px !important; }.alx-move-dialog-actions button { height: 32px; flex: 1; border: 0 !important; border-radius: 8px !important; padding: 1px 28px !important; font-size: 16px; }.alx-move-dialog-actions button:first-child { color: #000 !important; background: #fff !important; }.alx-move-dialog-actions button:last-child { color: #000 !important; background: linear-gradient(90deg, #ff7001, #ff9c2a) !important; }.alx-move-dialog-actions button:disabled { cursor: not-allowed; opacity: .45; }
