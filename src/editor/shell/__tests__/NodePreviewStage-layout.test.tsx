        ...
        ui: {
          overlays: {
            rage: {
              id: 'rage',
              title: '怒气值界面',
              children: [{ id: 'value', component: 'DamageFloatText', inputs: { parameter: 42 } }],
            },
          },
        },
      },
    ...
    const current = node('n1', {
      reactions: [
        ...
        },
        {
          ...
          do: [{ kind: 'spawn', from: 'float/rage', ttlMs: 1200, inputs: { parameter: { expr: 'delta' } } }],
        },
      ],
    })
      ...
      { nodes: [current], edges: [] },
      {
        ...
        ui: {
          overlays: {
            float: {
              id: 'float',
              children: [{ id: 'rage', component: 'DamageFloatText', inputs: { parameter: 0 } }],
            },
          },
        },
      },
