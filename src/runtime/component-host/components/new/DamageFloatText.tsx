...
import { floatAnimationStyle, injectCss, ensureBrushFont, resolveTextAppearance, type TextAppearanceInputs } from './skinRuntime'
...
export function DamageFloatText({ overlay, ctx, preview, previewTimeMs, previewPlaying }: OverlayProps): ReactNode {
  ...
  return (
    <div
      ...
      style={floatAnimationStyle(durationMs, frozen ? previewTimeMs ?? 0 : undefined)}
    >
...
.gv-damage-float-text span{font-family:'HYShangWei','STKaiti','KaiTi',serif;font-size:var(--gv-text-font-size,3.5cqh);font-weight:800;text-shadow:0 2px 6px rgba(0,0,0,.8);white-space:nowrap;animation:gv-damage-floatup var(--gv-float-duration,1100ms) ease-out forwards}
