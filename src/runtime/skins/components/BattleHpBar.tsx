...
// 尺寸/位置改用 cqw/cqh/cqmin（容器查询单位，相对 VideoOverlayStage 舞台——见 VideoOverlayStage.tsx
// 的 containerType:'size'）而非 vw/px/rem：vw 相对浏览器视口、px/rem 是绝对值，两者都不会跟着预览小窗
// 和全屏试玩的舞台实际像素等比缩放，是本次「预览/试玩组件大小不一致」的直接原因之一。装饰性细节
// （描边/阴影/字距/圆角）不影响「组件多大」，保留 px 不动。
const HUD_CSS = `
